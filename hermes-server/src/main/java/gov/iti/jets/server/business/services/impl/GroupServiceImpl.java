...
public class GroupServiceImpl implements GroupService {
    ...
    public void addNewGroupChat(GroupDetailsDto groupDetailsDto) {
        ...
        GroupEntity groupEntity = new GroupEntity(0,groupDetailsDto.groupFullName,groupDetailsDto.imageName,groupDetailsDto.contacts.size()+1);
        ...
        if(check==1){
            ...
            try (FileOutputStream fos = new FileOutputStream("hermes-server/src/main/resources/images/"+groupDetailsDto.groupFullName)) {
